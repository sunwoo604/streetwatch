...
def fetch_streetview_images(data, api_key, image_size='640x480'):
    image_counter = 0
    ...
    for location, image_parameters in data.items():
        for params in image_parameters:
            ...
            if response.status_code == 200:
                save_image(response.content, image_counter)
            else:
...
def save_image(content, image_counter):
    with open(f'streetview_image_{image_counter}.jpg', 'wb') as f:
        f.write(content)
